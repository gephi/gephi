...
@ServiceProvider(service = ProcessorUI.class, position = 4000)
public class MergeProcessorUI implements ProcessorUI {
    ...
    public boolean isUIFoProcessor(Processor processor) {
        return processor.getClass().equals(MergeProcessor.class);
    }
