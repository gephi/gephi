...
/**
 * <b>Optionally</b> implement this interface in a <code>Renderer</code> that
 * needs to be responsive to mouse events. Only renderers that implement this
 * interface will be drawn while mouse events are being attended (such as
 * dragging).
 *
