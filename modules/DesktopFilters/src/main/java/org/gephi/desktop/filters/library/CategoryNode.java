...
public class CategoryNode extends AbstractNode {
    ...
    public Image getIcon(int type) {
        ...
        if (category == null) {
            return ImageUtilities.loadImage("org/gephi/desktop/filters/library/resources/library.png", false);
        } else {
            return ImageUtilities.loadImage("org/gephi/desktop/filters/library/resources/folder.png", false);
        }
    }
