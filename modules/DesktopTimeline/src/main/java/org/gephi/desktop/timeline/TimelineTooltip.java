...
public class TimelineTooltip {
    ...
    private RichTooltip buildTooltip() {
        ...
        //Img
        richTooltip.setMainImage(ImageUtilities.loadImage("org/gephi/desktop/timeline/resources/info.png", false));
        ...
        if (getY() != null) {
            ...
            //Img
            richTooltip.setFooterImage(ImageUtilities.loadImage("org/gephi/desktop/timeline/resources/chart.png", false));
        }
