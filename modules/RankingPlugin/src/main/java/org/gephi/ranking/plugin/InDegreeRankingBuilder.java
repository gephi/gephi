...
/**
 * Ranking builder for graph in degree. Builds the {@link Ranking} instances
 * that performs the ranking for node in degrees.
 * <p>
 * The ranking is built for the workspace associated to the given
 * {@link RankingModel}.
 *
