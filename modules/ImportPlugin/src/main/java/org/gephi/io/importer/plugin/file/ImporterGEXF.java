...
public class ImporterGEXF implements FileImporter, LongTask {
    ...
    private void readGexf(XMLStreamReader reader) throws Exception {
        ...
        if (!version.isEmpty() && version.equals("1.0")) {
            report.logIssue(
                new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_log_version10"), Issue.Level.INFO));
        } else if (!version.isEmpty() && version.equals("1.1")) {
            report.logIssue(
                new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_log_version11"), Issue.Level.INFO));
        } else if (!version.isEmpty() && version.equals("1.2")) {
            report.logIssue(
                new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_log_version12"), Issue.Level.INFO));
        } else if (!version.isEmpty() && version.equals("1.3")) {
            report.logIssue(
                new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_log_version13"), Issue.Level.INFO));
        } else {
    ...
    private void readGraph(XMLStreamReader reader) throws Exception {
        ...
        if (!defaultEdgeType.isEmpty()) {
            if (defaultEdgeType.equalsIgnoreCase("undirected")) {
                ...
                report.logIssue(new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_edgedouble"),
                    Issue.Level.WARNING));
            } else {
                report.logIssue(new Issue(
                    NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_defaultedgetype", defaultEdgeType),
                    Issue.Level.SEVERE));
            }
        }
        ...
        if (!mode.isEmpty() && mode.equalsIgnoreCase("slice")) {
            if (timestamp.isEmpty() && (start.isEmpty() && end.isEmpty())) {
                report.logIssue(
                    new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_slice_bound_missing"),
                        Issue.Level.SEVERE));
            }
        ...
        if (!idType.isEmpty()) {
            if (idType.equalsIgnoreCase("integer")) {
                ...
                report.logIssue(
                    new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_idtype_error", idType),
                        Issue.Level.SEVERE));
            }
        }
    }
    ...
    private void readNode(XMLStreamReader reader) throws Exception {
        ...
        if (id.isEmpty()) {
            report.logIssue(
                new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_nodeid"), Issue.Level.SEVERE));
            return;
        }
        ...
        if (!pid.isEmpty()) {
            report.logIssue(
                new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_pid", id), Issue.Level.SEVERE));
        }
        ...
        if (!spells) {
            if ((!startDate.isEmpty() || !endDate.isEmpty()) && checkTimerepresentationIsInterval()) {
                if (startOpen || endOpen) {
                    report.logIssue(
                        new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_node_open_interval", id),
                            Issue.Level.WARNING));
                }
                try {
                    ...
                    report.logIssue(new Issue(
                        NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_node_timeinterval_parseerror", id),
                        Issue.Level.SEVERE));
                }
                ...
                try {
                    ...
                    report.logIssue(new Issue(
                        NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_node_timeintervals_parseerror", id),
                        Issue.Level.SEVERE));
                }
                ...
                try {
                    ...
                    report.logIssue(new Issue(
                        NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_node_timestamp_parseerror", id),
                        Issue.Level.SEVERE));
                }
                ...
                try {
                    ...
                    report.logIssue(new Issue(
                        NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_node_timestamps_parseerror", id),
                        Issue.Level.SEVERE));
                }
            }
        }
    ...
    private void readElementAttValue(XMLStreamReader reader, ElementDraft element) {
        ...
        if (fore.isEmpty()) {
            report.logIssue(new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_datakey", element),
                Issue.Level.SEVERE));
            return;
        }
        ...
        if (!value.isEmpty()) {
            ...
            ColumnDraft column =
                element instanceof NodeDraft ? container.getNodeColumn(fore) : container.getEdgeColumn(fore);
            if (column != null) {
                if (column.isDynamic()) {
                    if ((!startDate.isEmpty() || !endDate.isEmpty()) && checkTimerepresentationIsInterval()) {
                        if (startOpen || endOpen) {
                            report.logIssue(new Issue(NbBundle.getMessage(ImporterGEXF.class,
                                "importerGEXF_error_" + (element instanceof NodeDraft ? "node" : "edge") +
                                    "_open_interval", element), Issue.Level.WARNING));
                        }
                        try {
                            ...
                            report.logIssue(new Issue(NbBundle.getMessage(ImporterGEXF.class,
                                "importerGEXF_error_" + (element instanceof NodeDraft ? "node" : "edge") +
                                    "attribute_timeinterval_parseerror", element), Issue.Level.SEVERE));
                        }
                    } else if (!timestamp.isEmpty() && checkTimerepresentationIsTimestamp()) {
                        try {
                            ...
                            report.logIssue(new Issue(NbBundle.getMessage(ImporterGEXF.class,
                                "importerGEXF_error_" + (element instanceof NodeDraft ? "node" : "edge") +
                                    "attribute_timestamp_parseerror", element), Issue.Level.SEVERE));
                        }
                    } else {
                        try {
                            ...
                            if (checkTimerepresentationIsInterval()) {
                                ...
                                report.logIssue(new Issue(NbBundle.getMessage(ImporterGEXF.class,
                                    "importerGEXF_error_" + (element instanceof NodeDraft ? "node" : "edge") +
                                        "attribute_timeset_parseerror", element), Issue.Level.SEVERE));
                            }
                        }
                    }
                } else {
    ...
    private void readElementColor(XMLStreamReader reader, ElementDraft element) throws Exception {
        ...
        if (!hexStr.isEmpty()) {
            ...
            if (!aStr.isEmpty()) {
                ...
                if (a < 0f || a > 1f) {
                    report.logIssue(new Issue(NbBundle.getMessage(ImporterGEXF.class,
                        "importerGEXF_error_" + (element instanceof NodeDraft ? "node" : "edge") + "opacityvalue", aStr,
                        element), Issue.Level.WARNING));
                    a = 1f;
                }
            ...
            if (r < 0 || r > 255) {
                report.logIssue(new Issue(NbBundle.getMessage(ImporterGEXF.class,
                    "importerGEXF_error_" + (element instanceof NodeDraft ? "node" : "edge") + "colorvalue", rStr,
                    element, "r"), Issue.Level.WARNING));
                r = 0;
            }
            if (g < 0 || g > 255) {
                report.logIssue(new Issue(NbBundle.getMessage(ImporterGEXF.class,
                    "importerGEXF_error_" + (element instanceof NodeDraft ? "node" : "edge") + "colorvalue", gStr,
                    element, "g"), Issue.Level.WARNING));
                g = 0;
            }
            if (b < 0 || b > 255) {
                report.logIssue(new Issue(NbBundle.getMessage(ImporterGEXF.class,
                    "importerGEXF_error_" + (element instanceof NodeDraft ? "node" : "edge") + "colorvalue", bStr,
                    element, "b"), Issue.Level.WARNING));
                b = 0;
            }
            if (a < 0f || a > 1f) {
                report.logIssue(new Issue(NbBundle.getMessage(ImporterGEXF.class,
    ...
    private void readNodePosition(XMLStreamReader reader, NodeDraft node) throws Exception {
        ...
        if (!xStr.isEmpty()) {
            try {
                ...
                report.logIssue(
                    new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_nodeposition", node, "X"),
                        Issue.Level.WARNING));
            }
        }
        if (!yStr.isEmpty()) {
            try {
                ...
                report.logIssue(
                    new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_nodeposition", node, "Y"),
                        Issue.Level.WARNING));
            }
        }
        if (!zStr.isEmpty()) {
            try {
                ...
                report.logIssue(
                    new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_nodeposition", node, "Z"),
                        Issue.Level.WARNING));
            }
        }
    }
        ...
        if ("value".equalsIgnoreCase(attName)) {
            ...
            if (!sizeStr.isEmpty()) {
                try {
                    ...
                    report.logIssue(
                        new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_nodesize", node),
                            Issue.Level.WARNING));
                }
            }
        }
    ...
    private void readElementSpell(XMLStreamReader reader, ElementDraft element) throws Exception {
        ...
        if ((!start.isEmpty() || !end.isEmpty()) && checkTimerepresentationIsInterval()) {
            if (startOpen || endOpen) {
                report.logIssue(new Issue(NbBundle.getMessage(ImporterGEXF.class,
                    "importerGEXF_error_" + (element instanceof NodeDraft ? "node" : "edge") + "_open_interval",
                    element), Issue.Level.WARNING));
            }
            try {
                ...
                report.logIssue(new Issue(NbBundle.getMessage(ImporterGEXF.class,
                    "importerGEXF_error_" + (element instanceof NodeDraft ? "node" : "edge") +
                        "_timeinterval_parseerror", element), Issue.Level.SEVERE));
            }
        } else if (!timestamp.isEmpty() && checkTimerepresentationIsTimestamp()) {
            try {
                ...
                report.logIssue(new Issue(NbBundle.getMessage(ImporterGEXF.class,
                    "importerGEXF_error_" + (element instanceof NodeDraft ? "node" : "edge") + "_timestamp_parseerror",
                    element), Issue.Level.SEVERE));
            }
        }
    }
    ...
    private void readEdge(XMLStreamReader reader) throws Exception {
        ...
        try {
            ...
            if (source.isEmpty()) {
                report.logIssue(new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_edgesource"),
                    Issue.Level.SEVERE));
            } else if (target.isEmpty()) {
                report.logIssue(new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_edgetarget"),
                    Issue.Level.SEVERE));
            } else {
        ...
        if (!edgeType.isEmpty()) {
            if (edgeType.equalsIgnoreCase("undirected")) {
                ...
                report.logIssue(
                    new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_edgetype", edgeType, edge),
                        Issue.Level.SEVERE));
            }
        }
        ...
        if (!weight.isEmpty()) {
            try {
                ...
                report.logIssue(
                    new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_edgeweight", edge),
                        Issue.Level.WARNING));
            }
        }
        ...
        if (!spells) {
            if ((!startDate.isEmpty() || !endDate.isEmpty()) && checkTimerepresentationIsInterval()) {
                if (startOpen || endOpen) {
                    report.logIssue(new Issue(
                        NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_edge_open_interval", edge),
                        Issue.Level.WARNING));
                }
                try {
                    ...
                    report.logIssue(new Issue(NbBundle
                        .getMessage(ImporterGEXF.class, "importerGEXF_error_edge_timeinterval_parseerror", edge),
                        Issue.Level.SEVERE));
                }
            } else if (!intervals.isEmpty() && checkTimerepresentationIsInterval()) {
                try {
                    ...
                    report.logIssue(new Issue(NbBundle
                        .getMessage(ImporterGEXF.class, "importerGEXF_error_edge_timeintervals_parseerror", edge),
                        Issue.Level.SEVERE));
                }
            } else if (!timestamp.isEmpty() && checkTimerepresentationIsTimestamp()) {
                try {
                    ...
                    report.logIssue(new Issue(
                        NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_edge_timestamp_parseerror", edge),
                        Issue.Level.SEVERE));
                }
            } else if (!timestamps.isEmpty() && checkTimerepresentationIsTimestamp()) {
                try {
                    ...
                    report.logIssue(new Issue(
                        NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_edge_timestamps_parseerror", edge),
                        Issue.Level.SEVERE));
                }
            }
        }
    ...
    private void readAttribute(XMLStreamReader reader, String classAtt, String typeAtt) throws Exception {
        ...
        if (!id.isEmpty() && !type.isEmpty()) {
            ...
            if (classAtt.isEmpty() || !(classAtt.equalsIgnoreCase("node") || classAtt.equalsIgnoreCase("edge"))) {
                report.logIssue(
                    new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_attributeclass", title),
                        Issue.Level.SEVERE));
            }
            ...
            if (type.equalsIgnoreCase("boolean") || type.equalsIgnoreCase("bool")) {
                ...
                report.logIssue(
                    new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_attributetype2", type),
                        Issue.Level.SEVERE));
                return;
            }
            ...
            if ("node".equalsIgnoreCase(classAtt) || classAtt.isEmpty()) {
                ...
                report.log(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_log_nodeattribute", title,
                ...
                column.setTitle(title);
                report.log(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_log_edgeattribute", title,
                    attributeType.getCanonicalName()));
            }
            ...
            if (column != null && !defaultStr.isEmpty()) {
                try {
                    ...
                    report.logIssue(new Issue(NbBundle
                        .getMessage(ImporterGEXF.class, "importerGEXF_error_attributedefault", title,
                            attributeType.getCanonicalName()), Issue.Level.SEVERE));
                }
            }
        } else {
            report.logIssue(
                new Issue(NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_attributeempty", title),
                    Issue.Level.SEVERE));
        }
    }
    ...
    private boolean checkTimerepresentationIsInterval() {
        if (!container.getTimeRepresentation().equals(TimeRepresentation.INTERVAL)) {
            report.logIssue(new Issue(
                NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_timerepresentation_intervalerror"),
                Issue.Level.SEVERE));
            return false;
        }
        return true;
    ...
    private boolean checkTimerepresentationIsTimestamp() {
        if (!container.getTimeRepresentation().equals(TimeRepresentation.TIMESTAMP)) {
            report.logIssue(new Issue(
                NbBundle.getMessage(ImporterGEXF.class, "importerGEXF_error_timerepresentation_timestamperror"),
                Issue.Level.SEVERE));
            return false;
        }
        return true;
