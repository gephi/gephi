...
public class RendererManager extends javax.swing.JPanel implements PropertyChangeListener {
    ...
    private void buildTooltip() {
        ...
        richTooltip
            .setTitle(NbBundle.getMessage(RendererManager.class, "PreviewSettingsTopComponent.rendererManagerTab"));
    ...
    private void initComponents() {
        ...
        glue = new javax.swing.Box.Filler(new java.awt.Dimension(0, 0), new java.awt.Dimension(0, 0),
            new java.awt.Dimension(32767, 0));
        infoLabel = new javax.swing.JLabel();
        fill = new javax.swing.Box.Filler(new java.awt.Dimension(5, 0), new java.awt.Dimension(5, 0),
        ...
        restoreOrderButton.setText(org.openide.util.NbBundle
            .getMessage(RendererManager.class, "RendererManager.restoreOrderButton.text")); // NOI18N
        ...
        selectAllButton.setIcon(ImageUtilities.loadImageIcon("DesktopPreview/ui-check-box.svg", false)); // NOI18N
        ...
        unselectAllButon.setIcon(ImageUtilities.loadImageIcon("DesktopPreview/ui-check-box-uncheck.svg", false)); // NOI18N
        ...
        infoLabel.setIcon(ImageUtilities.loadImageIcon("DesktopPreview/info.svg", false)); // NOI18N
        infoLabel.setText(
    ...
    private void unselectAllButonActionPerformed(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_unselectAllButonActionPerformed
        setAllSelected(false);
    }//GEN-LAST:event_unselectAllButonActionPerformed

    private void restoreOrderButtonActionPerformed(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_restoreOrderButtonActionPerformed
        restoreRenderersList();
        refresh();
