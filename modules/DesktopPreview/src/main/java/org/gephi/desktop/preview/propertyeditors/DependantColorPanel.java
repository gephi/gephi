...
public class DependantColorPanel extends javax.swing.JPanel implements ItemListener {
    ...
    private void initComponents() {
        ...
        customRadio.setText(org.openide.util.NbBundle
            .getMessage(DependantColorPanel.class, "DependantColorPanel.customRadio.text")); // NOI18N

        buttonGroup1.add(parentRadio);
        parentRadio.setText(org.openide.util.NbBundle
            .getMessage(DependantColorPanel.class, "DependantColorPanel.parentRadio.text")); // NOI18N

        jXHeader1.setDescription(org.openide.util.NbBundle
            .getMessage(DependantColorPanel.class, "DependantColorPanel.jXHeader1.description")); // NOI18N
        jXHeader1.setTitle(org.openide.util.NbBundle
            .getMessage(DependantColorPanel.class, "DependantColorPanel.jXHeader1.title")); // NOI18N
