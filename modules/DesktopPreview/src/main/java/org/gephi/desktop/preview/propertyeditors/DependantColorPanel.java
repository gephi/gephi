...
public class DependantColorPanel extends javax.swing.JPanel implements ItemListener {
    ...
    private javax.swing.JRadioButton lighterButton;
    ...
    public DependantColorPanel() {
        ...
        lighterButton.addItemListener(this);
    }
    ...
    public void itemStateChanged(ItemEvent e) {
        if(e.getStateChange() == ItemEvent.SELECTED) {
            ...
            } else if (lighterButton.isSelected()) {
                selectedMode = DependantColor.Mode.LIGHTER;
            }
    ...
    public void setup(DependantColorPropertyEditor propertyEditor) {
        ...
        switch (dependantColor.getMode()) {
            ...
            case DARKER:
                ...
                break;
            case LIGHTER:
                lighterButton.setSelected(true);
                break;
            default:
                break;
        }
    ...
    private void initComponents() {
        ...
        lighterButton = new javax.swing.JRadioButton();
        ...
        buttonGroup1.add(lighterButton);
        lighterButton.setText(org.openide.util.NbBundle.getMessage(DependantColorPanel.class, "DependantColorPanel.lighterButton.text")); // NOI18N

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(this);
        this.setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jXHeader1, javax.swing.GroupLayout.PREFERRED_SIZE, 457, Short.MAX_VALUE)
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(parentRadio)
                    .addComponent(darkerButton)
                    .addComponent(lighterButton)
                    .addGroup(layout.createSequentialGroup()
