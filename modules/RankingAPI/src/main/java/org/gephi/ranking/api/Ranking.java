 ...
 * then send to transformer to be converted in visual signs (e.g. color or
 * size).
 * <p>
 ...
 * <p>
 * The
 * <code>getElementType()</code> method should return either
 * <code>Ranking.NODE_ELEMENT</code> or
 * <code>Ranking.EDGE_ELEMENT</code> to define if it works with node or edge
 * elements. This is important because it defines which objects the
 * <code>getValue()</code> eventually receives. For nodes, it is given a
 * {@link NodeData} object and for edges a {@link EdgeData}.
 * <p>
 * One can reuse the
 * <code>AbstractRanking</code> class defined in the
...
public interface Ranking<Element> {
    ...
    /**
     * Element type for nodes. The ranking receives a
     * <code>NodeData</code> object.
     */
    public static final String NODE_ELEMENT = "nodes";
    /**
     * Element type for edges. The ranking receives a
     * <code>EdgeData</code> object.
     */
    ...
    /**
     * Normalize
     * <code>value</code> between 0 and 1 using the minimum and the maximum
     * value. For example if
     * <code>value</code> is equal to the maximum, it returns 1.0.
     *
    ...
    /**
     * Unnormalize
     * <code>normalizedValue</code> and returns the original element value.
     *
    ...
    /**
     * Return the type of element this ranking is manipulating. Value can either
     * be
     * <code>Ranking.NODE_ELEMENT</code> or
     * <code>Ranking.EDGE_ELEMENT</code>.
     *
