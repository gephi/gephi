...
public final class AttributesPreferences {

    public static final String SHOW_NULL_COLUMNS = "Attributes.showNullColumns";
    public static final String INCLUDE_PROPERTIES = "Attributes.includeProperties";

    public static final boolean DEFAULT_SHOW_NULL_COLUMNS = false;
    public static final boolean DEFAULT_INCLUDE_PROPERTIES = true;

    private AttributesPreferences() {
    }

    public static boolean isShowNullColumns() {
        return NbPreferences.forModule(AttributesPreferences.class)
