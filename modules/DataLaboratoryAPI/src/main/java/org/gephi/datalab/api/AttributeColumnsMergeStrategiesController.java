...
public interface AttributeColumnsMergeStrategiesController {
     ...
     */
    Column joinWithSeparatorMerge(Table table, Column[] columnsToMerge, Class newColumnType, String newColumnTitle,
                                  String separator);
     ...
     */
    Column mergeNumericColumnsToTimeInterval(Table table, Column startColumn, Column endColumn, double defaultStart,
                                             double defaultEnd);
     ...
     * @return Time interval column
     */
    Column mergeDateColumnsToTimeInterval(Table table, Column startColumn, Column endColumn,
                                          SimpleDateFormat dateFormat, String defaultStartDate, String defaultEndDate);
     ...
     * @return The new created column
     */
    Column booleanLogicOperationsMerge(Table table, Column[] columnsToMerge, BooleanOperations[] booleanOperations,
