...
public class WizardPanel1Excel implements WizardDescriptor.Panel {
     ...
     */
    private WizardVisualPanel1Excel component;

    public WizardPanel1Excel(ImporterSpreadsheetExcel importer) {
    ...
    public Component getComponent() {
        if (component == null) {
            component = new WizardVisualPanel1Excel(importer, this);
        }
