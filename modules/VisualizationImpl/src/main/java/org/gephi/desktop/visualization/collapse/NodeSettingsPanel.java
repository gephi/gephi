...
public class NodeSettingsPanel extends javax.swing.JPanel implements VisualizationPropertyChangeListener {
    ...
    private void refreshSharedConfig(VisualizationModel vizModel) {
        int targetSlider = (int) Math.round(Math.log((double) vizModel.getNodeScale() / VizConfig.NODE_SCALE_MIN) /
    ...
    private void initComponents() {
        ...
        showNodesCheckbox.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
