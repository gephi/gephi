...
public class MinimumNumber implements AttributeRowsMergeStrategy {
    ...
    public void execute() {
        result = StatisticsUtils
            .minValue(Lookup.getDefault().lookup(AttributeColumnsController.class).getRowsColumnNumbers(rows, column));
    }
    ...
    @Override
    public Icon getIcon() {
        return ImageUtilities.loadImageIcon("DataLaboratoryPlugin/minus-white.png", true);
    }
}
