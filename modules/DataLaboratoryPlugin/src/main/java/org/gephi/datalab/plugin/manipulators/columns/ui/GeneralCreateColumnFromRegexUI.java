...
public class GeneralCreateColumnFromRegexUI extends javax.swing.JPanel implements AttributeColumnsManipulatorUI {
    ...
    public void setup(AttributeColumnsManipulator m, GraphModel graphModel, Table table, Column column,
        ...
        switch (mode) {
            case BOOLEAN:
                descriptionLabel.setText(NbBundle.getMessage(GeneralCreateColumnFromRegexUI.class,
                    "GeneralCreateColumnFromRegexUI.descriptionLabel.text.boolean", column.getTitle()));
                break;
            case MATCHING_GROUPS:
                descriptionLabel.setText(NbBundle.getMessage(GeneralCreateColumnFromRegexUI.class,
                    "GeneralCreateColumnFromRegexUI.descriptionLabel.text.matching_groups", column.getTitle()));
                break;
        }
        refreshPattern();
    }
    ...
    private void refreshOkButton() {
        ...
        dialogControls.setOkButtonEnabled(pattern != null && text != null && !text.isEmpty() &&
            !table.hasColumn(text));//Valid regex and title not empty and not repeated.
    }
    ...
    private void initComponents() {
        ...
        titleLabel.setText(org.openide.util.NbBundle.getMessage(GeneralCreateColumnFromRegexUI.class,
            "GeneralCreateColumnFromRegexUI.titleLabel.text")); // NOI18N

        titleTextField.setText(org.openide.util.NbBundle.getMessage(GeneralCreateColumnFromRegexUI.class,
            "GeneralCreateColumnFromRegexUI.titleTextField.text")); // NOI18N

        regexLabel.setText(org.openide.util.NbBundle.getMessage(GeneralCreateColumnFromRegexUI.class,
            "GeneralCreateColumnFromRegexUI.regexLabel.text")); // NOI18N

        regexTextField.setText(org.openide.util.NbBundle.getMessage(GeneralCreateColumnFromRegexUI.class,
            "GeneralCreateColumnFromRegexUI.regexTextField.text")); // NOI18N
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(descriptionLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 33,
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(regexLabel)
                        .addComponent(regexTextField, javax.swing.GroupLayout.PREFERRED_SIZE,
                            javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addContainerGap())
        );
