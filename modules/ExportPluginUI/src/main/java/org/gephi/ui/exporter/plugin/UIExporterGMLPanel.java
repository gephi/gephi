...
public class UIExporterGMLPanel extends javax.swing.JPanel implements ValidationClient {
    ...
    private void initComponents() {
        ...
        exportLabel.setText(
            org.openide.util.NbBundle.getMessage(UIExporterGMLPanel.class, "UIExporterGML.exportLabel.text")); // NOI18N

        exportPositionCheckBox.setText(org.openide.util.NbBundle
            .getMessage(UIExporterGMLPanel.class, "UIExporterGML.positionLabel.text")); // NOI18N

        exportColorsCheckBox.setText(
            org.openide.util.NbBundle.getMessage(UIExporterGMLPanel.class, "UIExporterGML.colorsLabel.text")); // NOI18N

        exportSizeCheckBox.setText(
            org.openide.util.NbBundle.getMessage(UIExporterGMLPanel.class, "UIExporterGML.sizeLabel.text")); // NOI18N

        exportEdgeWeightCheckBox.setText(org.openide.util.NbBundle
            .getMessage(UIExporterGMLPanel.class, "UIExporterGML.edgeWeightLabel.text")); // NOI18N

        exportNotRecognizedCheckBox.setText(
            org.openide.util.NbBundle.getMessage(UIExporterGMLPanel.class, "UIExporterGML.attributes.text")); // NOI18N
        ...
        normalizeCheckBox.setText(
            org.openide.util.NbBundle.getMessage(UIExporterGMLPanel.class, "UIExporterGML.normalize.text")); // NOI18N
        ...
        normalizeLabel.setText(org.openide.util.NbBundle
            .getMessage(UIExporterGMLPanel.class, "UIExporterGML.normalizeHintLabel.text")); // NOI18N

        exportLabelCheckBox.setText(
            org.openide.util.NbBundle.getMessage(UIExporterGMLPanel.class, "UIExporterGML.labelLabel.text")); // NOI18N

        spacesLabel.setText(org.openide.util.NbBundle
            .getMessage(UIExporterGMLPanel.class, "UIExporterGML.indentationLabel.text")); // NOI18N
            ...
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(spacesTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 60,
            ...
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(spacesLabel)
                        .addComponent(spacesTextField, javax.swing.GroupLayout.PREFERRED_SIZE,
