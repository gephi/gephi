...
public class UIExporterGDFPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        labelExport.setText(org.openide.util.NbBundle
            .getMessage(UIExporterGDFPanel.class, "UIExporterGDFPanel.labelExport.text")); // NOI18N

        positionExportCheckbox.setText(org.openide.util.NbBundle
            .getMessage(UIExporterGDFPanel.class, "UIExporterGDFPanel.positionExportCheckbox.text")); // NOI18N

        colorsExportCheckbox.setText(org.openide.util.NbBundle
            .getMessage(UIExporterGDFPanel.class, "UIExporterGDFPanel.colorsExportCheckbox.text")); // NOI18N

        attributesExportCheckbox.setText(org.openide.util.NbBundle
            .getMessage(UIExporterGDFPanel.class, "UIExporterGDFPanel.attributesExportCheckbox.text")); // NOI18N

        quotesCheckbox.setText(org.openide.util.NbBundle
            .getMessage(UIExporterGDFPanel.class, "UIExporterGDFPanel.quotesCheckbox.text")); // NOI18N
        ...
        labelQuotes.setText(org.openide.util.NbBundle
            .getMessage(UIExporterGDFPanel.class, "UIExporterGDFPanel.labelQuotes.text")); // NOI18N

        normalizeCheckbox.setText(org.openide.util.NbBundle
            .getMessage(UIExporterGDFPanel.class, "UIExporterGDFPanel.normalizeCheckbox.text")); // NOI18N
        ...
        labelNormalize.setText(org.openide.util.NbBundle
            .getMessage(UIExporterGDFPanel.class, "UIExporterGDFPanel.labelNormalize.text")); // NOI18N

        simpleQuotesCheckbox.setText(org.openide.util.NbBundle
            .getMessage(UIExporterGDFPanel.class, "UIExporterGDFPanel.simpleQuotesCheckbox.text")); // NOI18N

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings
            .createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, quotesCheckbox,
                org.jdesktop.beansbinding.ELProperty.create("${selected}"), simpleQuotesCheckbox,
        ...
        labelQuotes1.setText(org.openide.util.NbBundle
            .getMessage(UIExporterGDFPanel.class, "UIExporterGDFPanel.labelQuotes1.text")); // NOI18N

        visibilityCheckbox.setText(org.openide.util.NbBundle
            .getMessage(UIExporterGDFPanel.class, "UIExporterGDFPanel.visibilityCheckbox.text")); // NOI18N
    ...
    private void quotesCheckboxActionPerformed(
