 ...
 */
public class TimelineQuartzSimple implements TimelineQuartz {
...
class QuartzRunnable implements Runnable {
    ...
    private TimelineQuartzSimple master;

    QuartzRunnable(TimelineQuartzSimple master, long delay) {
        this.master = master;
        this.delay = delay;
    }
