 ...
 */
public class VisibleDescendantAndSelfIterator extends VisibleDescendantIterator implements Iterator<Node>, ResetableIterator {

    public VisibleDescendantAndSelfIterator(TreeStructure treeStructure) {
        super(treeStructure);
    }

    public VisibleDescendantAndSelfIterator(TreeStructure treeStructure, PreNode node) {
