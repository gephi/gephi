 ...
 */
public class VisibleChildrenIterator extends AbstractNodeIterator implements Iterator<Node>, ResetableIterator {
    ...
    public VisibleChildrenIterator(TreeStructure treeStructure) {
    ...
    public VisibleChildrenIterator(TreeStructure treeStructure, PreNode node) {
        this(treeStructure);
        setNode(node);
    }
