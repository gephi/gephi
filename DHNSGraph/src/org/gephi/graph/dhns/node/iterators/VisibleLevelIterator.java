 ...
 */
public class VisibleLevelIterator extends AbstractNodeIterator implements Iterator<Node> {
    ...
    public VisibleLevelIterator(TreeStructure treeStructure, int level) {
