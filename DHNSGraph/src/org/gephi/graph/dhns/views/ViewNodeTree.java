...
public class ViewNodeTree {
    ...
    public boolean add(AbstractNode item) {
        ...
        if (p == null) {
            this.root = new ViewNodeAVLNode(item);
        } else {
            while (true) {
                ...
                if (c < 0) {
                    if (p.left != null) {
                        ...
                        p.left = new ViewNodeAVLNode(item, p);
                        p.balance--;
                    ...
                    if (p.right != null) {
                        ...
                        p.right = new ViewNodeAVLNode(item, p);
                        p.balance++;
    ...
    public boolean remove(int number) {
        ...
        while (p != null) {
            ...
            if (c < 0) {
                ...
                ViewNodeAVLNode y; // node from which rebalancing begins
                ...
                {
                    ViewNodeAVLNode s = p.right.left;
    ...
    public Iterator<ViewNodeAVLNode> viewIterator() {
        return new ViewNodeAVLIterator(this);
    }
    ...
    public class ViewNodeAVLNode {

        ViewNodeAVLNode parent;
        ViewNodeAVLNode left;
        ViewNodeAVLNode right;
        int balance;
        AbstractNode item;
        int indegree;
        int outdegree;
        ...
        public ViewNodeAVLNode(AbstractNode item, ViewNodeAVLNode parent) {
            this.item = item;
            this.parent = parent;
        }
    ...
    private class ViewNodeAVLIterator implements Iterator<ViewNodeAVLNode>, ResetableIterator {

        private ViewNodeAVLNode next;
        private ViewNodeAVLNode current;

        public ViewNodeAVLIterator() {
        }

        public ViewNodeAVLIterator(ViewNodeAVLNode node) {
            this.next = node;
            goToDownLeft();
        }

        public ViewNodeAVLIterator(ViewNodeTree tree) {
            this(tree.root);
        }
        ...
        public ViewNodeAVLNode next() {
            return current;
        }

        public void remove() {
            ViewNodeTree.this.remove(current.item);
        }
    }
    ...
    private class AbstractNodeAVLIterator extends AbstractNodeIterator implements Iterator<AbstractNode>, ResetableIterator {
        ...
        public AbstractNodeAVLIterator(ViewNodeAVLNode node) {
            this.next = node;
            goToDownLeft();
        }
