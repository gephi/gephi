...
[![Downloads](https://img.shields.io/github/downloads/gephi/gephi/v0.10.0/total.svg)](https://github.com/gephi/gephi/releases/tag/v0.10.0)
...
Development builds are [generated regularly](https://github.com/gephi/gephi/actions/workflows/release.yml). Current version is 0.10.1-SNAPSHOT

- [gephi-0.10.1-SNAPSHOT-windows-x64.exe](https://oss.sonatype.org/service/local/artifact/maven/content?r=snapshots&g=org.gephi&a=gephi&v=0.10.1-SNAPSHOT&c=windows-x64&p=exe) (Windows)

- [gephi-0.10.1-SNAPSHOT-windows-x32.exe](https://oss.sonatype.org/service/local/artifact/maven/content?r=snapshots&g=org.gephi&a=gephi&v=0.10.1-SNAPSHOT&c=windows-x32&p=exe) (Windows x32)

- [gephi-0.10.1-SNAPSHOT-macos-x64.dmg](https://oss.sonatype.org/service/local/artifact/maven/content?r=snapshots&g=org.gephi&a=gephi&v=0.10.1-SNAPSHOT&c=macos-x64&p=dmg) (Mac OS X)

- [gephi-0.10.1-SNAPSHOT-macos-aarch64.dmg](https://oss.sonatype.org/service/local/artifact/maven/content?r=snapshots&g=org.gephi&a=gephi&v=0.10.1-SNAPSHOT&c=macos-aarch64&p=dmg) (Mac OS X Silicon)

- [gephi-0.10.1-SNAPSHOT-linux-x64.tar.gz](https://oss.sonatype.org/service/local/artifact/maven/content?r=snapshots&g=org.gephi&a=gephi&v=0.10.1-SNAPSHOT&c=linux-x64&p=tar.gz) (Linux)
