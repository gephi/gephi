...
/**
 * The statistics builder the graph node count statistics
 * @author Sebastien Heymann
 */
@ServiceProvider(service=StatisticsBuilder.class)
public class NodeCountBuilder implements StatisticsBuilder {

    public String getName() {
        return NbBundle.getMessage(NodeCountBuilder.class, "NodeCount.name");
    }
