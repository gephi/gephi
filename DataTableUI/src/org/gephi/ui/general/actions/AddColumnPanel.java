...
public class AddColumnPanel extends javax.swing.JPanel {
    ...
    public void setup(Mode mode){
        ...
        columnId=String.valueOf(table.countColumns()+1);
     ...
     */
    public void execute(){
        Lookup.getDefault().lookup(AttributesController.class).addAttributeColumn(table, columnId, titleTextField.getText(), availableTypes[typeComboBox.getSelectedIndex()]);
    }
