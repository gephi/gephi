...
public class QuadTreeTest {
    ...
    public void testMaxLevel1() {
        ...
        assertEquals(1, tree.q3.mass());
        assertEquals(1, tree.q3.x(), eps);

        assertEquals(1, tree.q1.mass());
    ...
    public void testLevel1Leaf() {
        ...
        assertEquals(4, tree.q1.mass());
        assertEquals(7.5, tree.q1.x(), eps);
        assertEquals(7.5, tree.q1.y(), eps);
