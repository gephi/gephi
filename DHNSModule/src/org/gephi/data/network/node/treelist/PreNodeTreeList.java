 ...
 */
/**
 * This class is a modification of the <b><code>TreeList</code></b> from Apache Commons Collections 3.1. Basically
 ...
 * <p>
 * The class has been modified in the following way. The global aim is to avoid any renumbering in the
 * <b>pre</b> order.
 * <ul><li>Tuned for only store {@link PreNode}. And <code>PreNode</code> knows his {@link AVLNode}.</li>
 * <li>The class know when the <b>pre</b> number of items is synchronized with indexes or not. See 
 * <code>preConsistent</code> integer.</li>
 * <li>When index are not synchronized the real index of {@link AVLNode} has to be retrieved.</li>
 * <li>That's why the parent node has been added to {@link AVLNode}. In that way retrieving an {@link AVLNode}
 * index can be performed in O(log(n)).</li></ul>
 * @author Joerg Schmuecker
 * @author Stephen Colebourne
 * @author Mathieu Bastian
 */
public class PreNodeTreeList extends AbstractList<PreNode> implements Iterable<PreNode> {
...
//  LinkedList =  270;7360;3350;55860;290720;2910;55200;
     ...
     */
    public PreNodeTreeList(Collection<PreNode> coll) {
        super();
        addAll(coll);
    }
    ...
    public Iterator<PreNode> iterator() {
        ...
        return new PreNodeTreeListIterator(this);
    }

    public Iterator<PreNode> iterator(int fromIndex) {
        // override to go 75% faster
        return new PreNodeTreeListIterator(this, fromIndex);
    }
    ...
    public void add(int index, PreNode obj) {
        ...
        incPreConsistent();
        if (root == null) {
            root = new AVLNode(this, index, obj, null, null, null);
        } else {
    ...
    public static class AVLNode {
         ...
         */
        private AVLNode(PreNodeTreeList treeParent, int relativePosition, PreNode obj, AVLNode rightFollower, AVLNode leftFollower, AVLNode parentNode) {
         ...
         */
        AVLNode insert(int index, PreNode obj) {
            int indexRelativeToMe = index - relativePosition;
        ...
        private AVLNode insertOnLeft(int indexRelativeToMe, PreNode obj) {
            AVLNode ret = this;

            if (getLeftSubTree() == null) {
                setLeft(new AVLNode(tree, -1, obj, this, left, this), null);
            } else {
        ...
        private AVLNode insertOnRight(int indexRelativeToMe, PreNode obj) {
            AVLNode ret = this;

            if (getRightSubTree() == null) {
                setRight(new AVLNode(tree, +1, obj, right, this, this), null);
            } else {
