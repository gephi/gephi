...
public class UIExporterGMLPanel extends javax.swing.JPanel implements ValidationClient {
    ...
    private void initComponents() {
        ...
        exportLabel.setText(org.openide.util.NbBundle.getMessage(UIExporterGMLPanel.class, "exportLabel.text")); // NOI18N

        exportPositionCheckBox.setText(org.openide.util.NbBundle.getMessage(UIExporterGMLPanel.class, "positionLabel.text")); // NOI18N

        exportColorsCheckBox.setText(org.openide.util.NbBundle.getMessage(UIExporterGMLPanel.class, "colorsLabel.text")); // NOI18N

        exportSizeCheckBox.setText(org.openide.util.NbBundle.getMessage(UIExporterGMLPanel.class, "sizeLabel.text")); // NOI18N
        ...
        normalizeLabel.setText(org.openide.util.NbBundle.getMessage(UIExporterGMLPanel.class, "normalizeHintLabel.text")); // NOI18N

        exportLabelCheckBox.setText(org.openide.util.NbBundle.getMessage(UIExporterGMLPanel.class, "labelLabel.text")); // NOI18N

        spacesLabel.setText(org.openide.util.NbBundle.getMessage(UIExporterGMLPanel.class, "indentationLabel.text")); // NOI18N
