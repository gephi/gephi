...
public class MinimumNumber implements AttributeColumnsMergeStrategy{
    ...
    public void execute() {
        String title=JOptionPane.showInputDialog(null, NbBundle.getMessage(MinimumNumber.class, "Strategies.columnTitle.dialog.text"));
        if(title!=null){
            Lookup.getDefault().lookup(AttributeColumnsMergeStrategiesController.class).minValueNumbersMerge(table, columns, title);
        }
    }
    ...
    public Icon getIcon() {
        return ImageUtilities.loadImageIcon("org/gephi/datalaboratory/impl/manipulators/resources/minus-white.png",true);
    }
