 ...
 */
public class InterQuartileRangeNumber implements AttributeColumnsMergeStrategy{
    ...
    public void execute() {
        String title=JOptionPane.showInputDialog(null, NbBundle.getMessage(InterQuartileRangeNumber.class, "Strategies.columnTitle.dialog.text"));
        if(title!=null){
            Lookup.getDefault().lookup(AttributeColumnsMergeStrategiesController.class).interQuartileRangeNumberMerge(table, columns, title);
        }
    }
