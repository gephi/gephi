...
//copypasted JColorButton with listeners actions change
public class JColorBlackWhiteSwitcher extends JButton {
    ...
    public JColorBlackWhiteSwitcher(Color originalColor) {
        this(originalColor, false, false);
    }

    public JColorBlackWhiteSwitcher(Color originalColor, boolean rightClick, boolean includeOpacity) {
