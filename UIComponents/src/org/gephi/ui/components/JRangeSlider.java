...
public class JRangeSlider extends JSlider {
    ...
    public void updateUI() {
        ...
        if (uiv instanceof WindowsSliderUI) {
            BasicSliderUI basicSliderUI = (BasicSliderUI)uiv;
            uiv = new JRangeSliderUI(basicSliderUI, this);
        }
        setUI(uiv);
    ...
    private static class JRangeSliderUI extends BasicSliderUI {
        ...
        private BasicSliderUI originalUI;

        /**
         * Constructs a RangeSliderUI for the specified slider component.
         * @param b RangeSlider
         */
        public JRangeSliderUI(BasicSliderUI originalUI, JSlider slider) {
            super(slider);
